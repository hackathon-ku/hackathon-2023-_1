...
function ContinuousCalendar() {
	...
	const handleshowFilterFac = () => {
		setshowFilterFac(true);
	}
					...
					<div className=' w-[40em] h-[40em] sm:w-[25rem] bg-white rounded-[20px]'>
						<div className='header flex justify-evenly'>
							<div className='flex-col justify-evenly'>
								...
								<div className='w-[120px] h-[140px] flex flex-col justify-center items-center'>
									<div className='w-12 h-12 bg-pink-500 rounded-full hover:bg-pink-900 hover:duration-500 duration-500 cursor-pointer'></div>
									<h1>กิจกรรม</h1>
									<h1></h1>
								</div>
								<div className='w-[120px] h-[140px] flex flex-col justify-center items-center'>
									<div className='w-12 h-12 bg-green-500 rounded-full hover:bg-green-900 hover:duration-500 duration-500 cursor-pointer'></div>
									<h1>ชมรม/คณะ</h1>
									<h1></h1>
								</div>
							</div>
